...
int main(int argc, char* argv[]) {
    ...
    auto join_6_op = Table_Interval_Join_Builder<source_self_theta_join_from_3_unified_renaming_for_self_join_select_4_struct_out, source_self_theta_join_from_3_unified_renaming_for_self_join_select_4_struct_out>(
    ...
    if( !(((right.hum > 50) && (left.temperature < 20)))){
        return std::nullopt;
    }
    ...
    .withName("self_theta_join_join_interval_2")
    .withParallelism(2)
    .build();
 ...
 os << record.sensor_id << ","; os << record.sens << ","; os << record.temperature << ","; os << record.hum;}
)
