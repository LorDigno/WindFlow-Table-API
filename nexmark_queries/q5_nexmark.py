...
job = env.execute(hot_auctions, rexecute=True, output_dir="./query5")

# Controlli disponibili sul JobHandler:
print("Job in esecuzione:", job.is_running())
print("PID del processo:", job.pid)
