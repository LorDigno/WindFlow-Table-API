...
int main(int argc, char* argv[]) {
    ...
    auto from_1_op = Table_Source_Builder<source_auction_expanded_from_4>( "/disc1/homes/lorenzoni/WindFlow-Table-API/nexmark_datasets/70m_auction.csv",
    ...
    .withHeader()
    .withParallelism(5, 268435456ULL)
    .withOrderedEventTime(auction_expanded_epoch)
    .build();
