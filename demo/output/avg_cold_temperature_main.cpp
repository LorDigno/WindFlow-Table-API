...
int main(int argc, char* argv[]) {
    ...
    auto group_4_op = Windowed_Group_Builder<source_cold_and_dry_from_6, avg_cold_temperature_window_group_by_2_struct_out, avg_cold_temperature_window_group_by_2_key_struct>(
    [](const source_cold_and_dry_from_6& in, avg_cold_temperature_window_group_by_2_struct_out& out) -> void {
    out.sensor_id = in.sensor_id;
    ...
    .withName("avg_cold_temperature_window_group_by_2")
    .withParallelism(2)
    .withTBWindow(120000000ULL, 60000000ULL)
    .withKeyBy([](const source_cold_and_dry_from_6& in) -> avg_cold_temperature_window_group_by_2_key_struct {
    avg_cold_temperature_window_group_by_2_key_struct out;
    out.sensor_id = in.sensor_id;
    return out;
})
    .build_keyed();
    ...
    auto select_5_op = Select_Builder<avg_cold_temperature_window_group_by_2_struct_out, avg_cold_temperature_select_1_struct_out>(
        [](const avg_cold_temperature_window_group_by_2_struct_out& in) -> avg_cold_temperature_select_1_struct_out {
